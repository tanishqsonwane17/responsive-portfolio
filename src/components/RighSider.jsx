...
const RighSider = () => {
  return (
    <div className="MainDiv h-full w-full bg-cover bg-center bg-[rgb(20,19,26)] bg-no-repeat  left-[12vw] overflow-x-hidden relative before:content-[''] before:absolute before:inset-0  before:mix-blend-overlay">
    <section id='Home'>
    <div className='profileParent flex h-28  w-full  p-1  md:relative fixed'>
      <div className="profile h-20 w-20  rounded-full ml-[2vw] my-4 md:border-2 ">
        <img className="h-full w-full object-cover overflow-hidden rounded-full" src="me.jpg" alt="" />
...
<p className='font-bold'>For me, coding is more than a skill—it's an art form, and every line I write is a brushstroke on the canvas of innovation.</p>
            <br /><br />
